...
public class MainController {
    ...
    public @ResponseBody String addNewUser(@RequestParam String name, @RequestParam String raza,
    ...
    public @ResponseBody String editUser(@RequestParam String name, @RequestParam String raza, @RequestParam String propietario,
    ...
    public @ResponseBody List<Map<String, Object>> getReport() {
        String sql = "SELECT CONCAT(name, '(nombre) ==> (raza)', raza) as MIS_USUARIOS FROM user;";
